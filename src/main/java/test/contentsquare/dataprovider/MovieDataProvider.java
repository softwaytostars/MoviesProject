package test.contentsquare.dataprovider;
...
public class MovieDataProvider {
    ...
    private Movie createMovieFrom(String line) {
        ...
        try {
            ...
            // call a validation function that throws if the movie is not correct
            movie.validate();
    ...
    // provideMoviesFrom creates a list of Movie objects reading line by the input file
